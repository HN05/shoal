...
- Scope: workspace commands carry a scope token and get own-worktree access
  ...
  records and conflicting actions; manual acknowledgements bind to exactly the
  recorded HEAD. This is cooperative, not a security boundary, so judge it as such.
