        ...
        with tempfile.TemporaryDirectory() as root:
            ...
            def pull(number, sha, **extra):
                return dict(number=number, title=f"PR {number}", body="", merged=True,
                            base={"ref": "main", "repo": {"full_name": "owner/repo"}}, merge_commit_sha=sha) | extra
            ...
            responses = {
                ...
                "/pulls?state=closed&limit=50&page=2": [
                    ...
                    pull(11, target, head={"ref": "refs/pull/11/head", "label": "release/v0.2.0",
                                           "repo": {"full_name": "fork/repo"}}),
                    pull(12, target, head={"ref": "refs/pull/99/head", "label": "release/v0.2.0",
                                           "repo": {"full_name": "owner/repo"}})],
            ...
            for number in (10, 11, 12):
                self.assertIn(f"- PR {number}", notes)
