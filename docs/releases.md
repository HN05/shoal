...
- `RELEASE_AUTOMATION_TOKEN`: Actions secret for a user/bot with permission to
  ...
  ensures publication triggers the Homebrew workflow.
...
Builds use the public Rust image and install pinned Worktrunk and Forgejo CLI
versions. The release remains source-built through Homebrew; prebuilt bottles
